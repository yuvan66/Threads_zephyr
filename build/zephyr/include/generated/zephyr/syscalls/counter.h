...
extern int z_impl_counter_set_calibration(const struct device * dev, int32_t calibration);

static inline int counter_set_calibration(const struct device * dev, int32_t calibration)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		union { uintptr_t x; const struct device * val; } parm0 = { .val = dev };
		union { uintptr_t x; int32_t val; } parm1 = { .val = calibration };
		return (int) arch_syscall_invoke2(parm0.x, parm1.x, K_SYSCALL_COUNTER_SET_CALIBRATION);
	}
#endif
	compiler_barrier();
...
#define counter_set_calibration(dev, calibration) ({ 	int syscall__retval; 	sys_port_trace_syscall_enter(K_SYSCALL_COUNTER_SET_CALIBRATION, counter_set_calibration, dev, calibration); 	syscall__retval = counter_set_calibration(dev, calibration); 	sys_port_trace_syscall_exit(K_SYSCALL_COUNTER_SET_CALIBRATION, counter_set_calibration, dev, calibration, syscall__retval); 	syscall__retval; })
#endif
#endif


extern int z_impl_counter_get_calibration(const struct device * dev, int32_t * calibration);

static inline int counter_get_calibration(const struct device * dev, int32_t * calibration)
{
#ifdef CONFIG_USERSPACE
	if (z_syscall_trap()) {
		union { uintptr_t x; const struct device * val; } parm0 = { .val = dev };
		union { uintptr_t x; int32_t * val; } parm1 = { .val = calibration };
		return (int) arch_syscall_invoke2(parm0.x, parm1.x, K_SYSCALL_COUNTER_GET_CALIBRATION);
	}
#endif
	compiler_barrier();
...
#define counter_get_calibration(dev, calibration) ({ 	int syscall__retval; 	sys_port_trace_syscall_enter(K_SYSCALL_COUNTER_GET_CALIBRATION, counter_get_calibration, dev, calibration); 	syscall__retval = counter_get_calibration(dev, calibration); 	sys_port_trace_syscall_exit(K_SYSCALL_COUNTER_GET_CALIBRATION, counter_get_calibration, dev, calibration, syscall__retval); 	syscall__retval; })
#endif
#endif
